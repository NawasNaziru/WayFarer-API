...
INSERT INTO trips(id, bus_id, origin, destination, trip_date, fare ) VALUES(nextval('generic_sequence'), 2, 'Lagos', 'Abuja', '2019-07-29', 20050.89);
INSERT INTO bookings(id, trip_id, user_id, seat_number, created_on) VALUES(nextval('generic_sequence'),1, 2, 1, '2019-07-29');
COMMIT;
